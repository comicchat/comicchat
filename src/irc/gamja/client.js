// Vendored from gamja (https://git.sr.ht/~emersion/gamja, mirror github.com/Libera-Chat/gamja)
// Copyright (C) the gamja contributors. Licensed under AGPL-3.0-or-later.
// See src/irc/gamja/LICENSE for the full license text.
